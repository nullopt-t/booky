...
type ProductRepository interface {
	...
	CreateCategory(ctx context.Context, db database.QueryExecutor, name string) (*model.ProductCategory, error)
	GetAllCategories(ctx context.Context, db database.QueryExecutor, q *api.PageQuery) ([]*model.ProductCategory, *api.Page, error)
}
...
func (r *PostgresRepo) CreateCategory(ctx context.Context, qe database.QueryExecutor, name string) (*model.ProductCategory, error) {
...
func (r *PostgresRepo) GetAllCategories(ctx context.Context, qe database.QueryExecutor, q *api.PageQuery) ([]*model.ProductCategory, *api.Page, error) {
	offset := (q.Page - 1) * q.Limit
	rows, err := qe.Query(ctx, `
