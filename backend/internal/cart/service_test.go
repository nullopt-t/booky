...
type MockCartRepository struct {
	CreateFn      func(ctx context.Context, db database.QueryExecutor, userID uuid.UUID) (*model.Cart, error)
	GetByUserIDFn func(ctx context.Context, db database.QueryExecutor, userID uuid.UUID) (*model.Cart, error)
	EmptyFn       func(ctx context.Context, db database.QueryExecutor, userID uuid.UUID) error
	SaveFn        func(ctx context.Context, db database.QueryExecutor, cart *model.Cart) error
}

func (m *MockCartRepository) Create(ctx context.Context, db database.QueryExecutor, userID uuid.UUID) (*model.Cart, error) {
	if m.CreateFn == nil {
		panic("CreateFn is not set")
	}
	return m.CreateFn(ctx, db, userID)
}
func (m *MockCartRepository) GetByUserID(ctx context.Context, db database.QueryExecutor, userID uuid.UUID) (*model.Cart, error) {
	if m.GetByUserIDFn == nil {
		panic("GetByUserIDFn is not set")
	}
	return m.GetByUserIDFn(ctx, db, userID)
}
func (m *MockCartRepository) Empty(ctx context.Context, db database.QueryExecutor, userID uuid.UUID) error {
	if m.EmptyFn == nil {
		panic("EmptyFn is not set")
	}
	return m.EmptyFn(ctx, db, userID)
}
func (m *MockCartRepository) Save(ctx context.Context, db database.QueryExecutor, cart *model.Cart) error {
	if m.SaveFn == nil {
...
func TestGetCart(t *testing.T) {
	...
	t.Run("success: returns items and correct total", func(t *testing.T) {
		...
		repo := &MockCartRepository{
			GetByUserIDFn: func(_ context.Context, _ database.QueryExecutor, _ uuid.UUID) (*model.Cart, error) {
	...
	t.Run("get fails, create succeeds: returns empty cart", func(t *testing.T) {
		...
		repo := &MockCartRepository{
			...
			CreateFn: func(_ context.Context, _ database.QueryExecutor, id uuid.UUID) (*model.Cart, error) {
		...
		if cart.UserID != userID {
			t.Fatalf("expected empty cart for user %v, got %+v", userID, cart)
		}
	})
	...
	t.Run("get and create both fail: returns error", func(t *testing.T) {
		repo := &MockCartRepository{
			...
			CreateFn: func(_ context.Context, _ database.QueryExecutor, _ uuid.UUID) (*model.Cart, error) {
...
func TestEmptyCart(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		repo := &MockCartRepository{EmptyFn: func(_ context.Context, _ database.QueryExecutor, _ uuid.UUID) error { return nil }}
	...
	t.Run("transaction failure", func(t *testing.T) {
		runner := &MockRunner{
			WithTxFn: func(_ context.Context, _ func(database.QueryExecutor) error) error {
...
func TestAddItem(t *testing.T) {
	...
	t.Run("new product appended to cart", func(t *testing.T) {
		...
		repo := &MockCartRepository{
			...
			SaveFn: func(_ context.Context, _ database.QueryExecutor, cart *model.Cart) error {
				if len(cart.Items) != 2 {
	...
	t.Run("save fails: returns error", func(t *testing.T) {
		repo := &MockCartRepository{
			...
			SaveFn: func(_ context.Context, _ database.QueryExecutor, _ *model.Cart) error {
